...
// +-------------------------------------------------+
// $Id: relance.inc.php,v 1.102 2019-07-31 14:48:32 dgoron Exp $
...
function filter_niveau($liste_ids,$champ,$selected = array(),$sort=false) {
...
function filter_loc_expl($liste_ids, $champ, $selected = array(), $sort = false){
	global $dbh,$charset;
