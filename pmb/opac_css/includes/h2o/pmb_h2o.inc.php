...
// +-------------------------------------------------+
// $Id: pmb_h2o.inc.php,v 1.40 2019-07-10 06:44:08 btafforeau Exp $
...
function recursive_lookup($name,$context) {
	...
	$value = $context->getVariable(substr($attributes[0], 1));
	if ((is_object($value) || is_array($value)) && (count($attributes) > 1)) {
		$obj = $value;
