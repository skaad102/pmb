		...
		while ($row = pmb_mysql_fetch_object($result)) {
			...
			for ($i=0; $i<count($emails_empr); $i++) {
				if (strtolower($email) == strtolower($emails_empr[$i])) {
					...
					// cl� pour autoriser une seule connexion auto :
					...
					// Bonjour,<br /><br />Pour faire suite � votre demande de r�initialisation de mot de passe � <b>!!biblioname!!</b>, veuillez trouver ci-dessous le lien qui vous permettra d'effectuer ce changement : <br /><br />!!lien_mdp!!<br /><br /> - Pour rappel, votre identifiant est : !!login!!<br /><br />Si vous rencontrez des difficult�s, adressez un mail � !!biblioemail!!.<br /><br />
