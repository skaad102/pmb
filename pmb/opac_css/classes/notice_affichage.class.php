...
class notice_affichage {
	...
	public $notice_indexations	= "" ;		// Affichage des indexations cat�gories et mots cl�s, peut �tre ajout� � $notice_isbd ou � $notice_public afin d'avoir l'affichage complet PMB
	public $notice_exemplaires	= "" ;		// Affichage des exemplaires, peut �tre ajout� � $notice_isbd ou � $notice_public afin d'avoir l'affichage complet PMB
	public $notice_explnum	= "" ;			// Affichage des exemplaires num�riques, peut �tre ajout� � $notice_isbd ou � $notice_public afin d'avoir l'affichage complet PMB
	public $notice_notes	= "" ;			// Affichage des notes de contenu et r�sum�, peut �tre ajout� � $notice_isbd ou � $notice_public afin d'avoir l'affichage complet PMB
	...
	public $auteurs_principaux	= "" ;		// ce qui apparait apr�s le titre pour le header
  	public $auteurs_tous	= "" ;		// Tous les auteurs avec leur fonction
  	public $categories_toutes	= "" ;		// Toutes les cat�gories dans lesquelles est rang�e la notice
	...
	public $to_print = 0;
	public $affichage_resa_expl = "" ; // lien r�servation, exemplaires et exemplaires num�riques, en tableau comme il faut
	public $affichage_expl = "" ;  // la m�me chose mais sans le lien r�servation
	public $affichage_avis_detail=""; // affichage des avis de lecteurs

	public $statut = 1 ;  			// Statut (id) de la notice
	public $statut_notice = "" ;  	// Statut (libell�) de la notice
	public $visu_notice = 1 ;  	// Visibilit� de la notice � tout le monde
	public $visu_notice_abon = 0 ; // Visibilit� de la notice aux abonn�s uniquement
	public $visu_expl = 1 ;  		// Visibilit� des exemplaires de la notice � tout le monde
	public $visu_expl_abon = 0 ;  	// Visibilit� des exemplaires de la notice aux abonn�s uniquement
	public $visu_explnum = 1 ;  	// Visibilit� des exemplaires num�riques de la notice � tout le monde
	public $visu_explnum_abon = 0 ;// Visibilit� des exemplaires num�riques de la notice aux abonn�s uniquement
	public $visu_scan_request = 1; // Visibilit� du lien de demande de num�risation
	public $visu_scan_request_abon = 0; // Visibilit� du lien de demande de num�risation aux abonn�s uniquement

	public $childs = array() ; // filles de la notice
	public $notice_childs = "" ; // l'�quivalent � afficher
	public $anti_loop="";
	public $seule = 0 ;
	...
	public $header_only = 0;		// pour ne prendre que le n�cessaire pour composer le titre
	public $parents = "";			// la chaine des parents, utilis�e pour do_parents en isbd et en public
	public $no_header = 0 ;		// ne pas afficher de header, permet de masquer l'ic�ne
	public $notice_header_without_doclink=""; // notice_header sans les icones de lien url et d'indication de documents num�riques
	public $notice_header_doclink=""; // les icones de lien url et d'indication de documents num�riques
	...
	protected $affichage_demand = ""; // Bouton de cr�ation de demande � partir d'une notice
	protected $affichage_scan_requests = ""; // Bouton de cr�ation de demande de num�risation � partir d'une notice
	...
	protected $display_childs = true; //affichage ou non des notices filles (d�rivable en classe d'aff perso)
...
// 			}
	...
	// requ�te de r�cup�ration des categories ------------------------------------------------------------------
	...
	//Affichage de l'ic�ne permettant d'ajouter la notice � une liste de lecture
	...
	public function aff_suite() {
		...
		$ret_index = "";
		// Cat�gories
		// On demande � afficher le header seulement et on arrive ici..appelons donc le fetch_categories
		if($this->header_only) {
	...
	// fonction de g�n�ration d'une colonne du tableau des exemplaires
	...
	/**
	 * Retourne les informations d'exemplaires rattach�s � la notice
	 */
	...
	/**
	 * V�rifie que la requ�te Ajax soit bien envoy�e par une action utilisateur
	 */
