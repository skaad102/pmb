...
// +-------------------------------------------------+
// $Id: rss_flux.class.php,v 1.43 2019-06-25 09:31:22 dgoron Exp $
...
// ---------------------------------------------------------------
	...
	public function getData() {
		if (!$this->id_rss_flux) {
			...
			$requete = "SELECT id_rss_flux, nom_rss_flux, link_rss_flux, descr_rss_flux, metadata_rss_flux, lang_rss_flux, copy_rss_flux, editor_rss_flux, webmaster_rss_flux, ttl_rss_flux, img_url_rss_flux, img_title_rss_flux, img_link_rss_flux, format_flux, export_court_flux,tpl_rss_flux,";
