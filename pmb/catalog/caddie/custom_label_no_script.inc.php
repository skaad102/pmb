...
// +-------------------------------------------------+
// $Id: custom_label_no_script.inc.php,v 1.19 2019-09-03 14:49:09 dgoron Exp $
...
function print_cote(&$target, $content_value, $content_src='') {
	...
	$target->MultiCell($content_value['width'], ($content_value['font_size']*25.4/72), $str_cote, $border,  $content_value['align']);
