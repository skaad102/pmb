...
<div id='el0Child' class='child' etirable='yes' title='".htmlentities($msg[236],ENT_QUOTES, $charset)."' >
    ...
    <div id='el0Child_1' title='".htmlentities($msg[238],ENT_QUOTES, $charset)."' movable='yes'>
	    <!--    Titre propre d'un auteur diff�rent    -->
...
if($pmb_authors_qualification){
	$authors_qualification_tpl="
	        ...
	        <div  id='el1Child_2a_vedettes' style='float:left;'>
				...
				<div class='row'>
					<img class='img_plus' hspace='3' border='0' onclick=\"expand_vedette(this,'vedette0'); return false;\" title='d�tail' name='imEx' src='".get_url_icon('plus.gif')."'>
...
if($pmb_authors_qualification){
	...
	$authors_qualification_tpl="
        ...
        <div id='el1Child_2b_others_vedettes' style='float:left;'>
			<img class='img_plus' hspace='3' border='0' onclick=\"expand_vedette(this,'vedette!!iaut!!_autre'); return false;\" title='d�tail' name='imEx' src='".get_url_icon('plus.gif')."'>
...
if (!empty($pmb_authors_qualification)) {
	...
	$authors_qualification_tpl = "
        ...
        <div id='el1Child_3b_others_vedettes' style='float:left;'>
			<img class='img_plus' hspace='3' border='0' onclick=\"expand_vedette(this,'vedette!!iaut!!_secondaire'); return false;\" title='d�tail' name='imEx' src='".get_url_icon('plus.gif')."'>
