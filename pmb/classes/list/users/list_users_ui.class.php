...
// +-------------------------------------------------+
// $Id: list_users_ui.class.php,v 1.1 2019-07-11 12:16:59 dgoron Exp $
...
// 	        'confirm' => ''
	...
	protected function get_selection_actions() {
	    ...
	    if(!isset($this->selection_actions)) {
	        ...
	        //Bouton modifier
// 	        $this->selection_actions[] = $this->get_selection_action('edit', $msg['62'], 'b_edit.png', $this->get_link_action('list_edit', 'edit'));
