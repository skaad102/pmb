...
// +-------------------------------------------------+
// $Id: list_scan_requests_ui.class.php,v 1.2 2019-07-30 13:29:35 ngantier Exp $
...
class list_scan_requests_ui extends list_ui {
	...
	public function get_display_header_list() {
	    ...
	    $scan_request_order_by = $this->applied_sort['by'];
	    $scan_request_order_by_sens = ($this->applied_sort['asc_desc'] ? $this->applied_sort['asc_desc'] : 'asc');
	    $display = '';
