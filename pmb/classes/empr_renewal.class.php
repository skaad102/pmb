...
// +-------------------------------------------------+
// $Id: empr_renewal.class.php,v 1.4 2019-07-30 11:57:24 ngantier Exp $
...
class empr_renewal {
	...
	public function get_form() {
		...
		global $charset, $empr_renewal_activate;
	...
	public function get_empr_fields() {
		...
		$this->empr_fields = array(
		        ...
		        'empr_msg' => array('field_label' => $msg['empr_msg'], 'display' => 1, 'mandatory' => 0, 'alterable' => 1, 'explanation' => '', 'force_mandatory' => 0),		    
		);
